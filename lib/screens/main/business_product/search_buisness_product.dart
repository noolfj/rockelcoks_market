...
class SearchBusinessWidget extends StatefulWidget {
  ...
  @override
  State<SearchBusinessWidget> createState() => _SearchBusinessWidgetState();
}

class _SearchBusinessWidgetState extends State<SearchBusinessWidget> {
